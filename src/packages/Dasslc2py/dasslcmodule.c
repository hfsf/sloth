/*##################################################################################################
#                                                                                                  #
#   This is the source code of the python wrapper for the "Differential-Algebraic System Solver    #
#   in C" by Argimiro R. Secchi (PEQ/COPPE/UFRJ)                                                   #
#                                                                                                  #
#   Author: Ataide Neto                                                                            #
 ...
 * v0.1-2 Added: inputfile and user-defined jacobian support (dense and band)                      *
 * v0.1-3 Added: solve for the steady state and sparse algebra support                             *
...
static PyObject* dasslc_solve(PyObject *self, PyObject *args){
    ...
    int ntp = -1, ntp2 = -1, neq = -1, ndr = -1, idxnum = -1, *index = NULL, i = 0, j = 0;
    double t0 = 0, tf = 0, dt = 0, *y = NULL, *yp = NULL;
    PyArrayObject *t_sol = NULL, *y_sol = NULL, *yp_sol = NULL;
    PyArrayObject *t_array = NULL, *y_array = NULL, *yp_array = NULL, *idx_array = NULL;
    ...
    PyObject *t_obj = NULL, *y_obj = NULL, *resfun_obj = NULL; //mandatory
    PyObject *yp_obj = NULL, *rpar_obj = NULL, *idx_obj = NULL, *jac_obj = NULL; //optional
